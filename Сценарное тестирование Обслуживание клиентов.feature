...
Контекст:
	...
	И Я запоминаю значение выражения '"D:\Обработки1С\Документ Microsoft Word.docx"' в переменную "ПутьКФайлу"
...
Сценарий: Планирование нескольких обслуживаний, закрытие обслуживаний, массовое создание актов, формирование отчёта Анализ выставленых актов
	...
	И в поле с именем 'Дата' я ввожу текст '15.07.2025  0:00:00'
	И из выпадающего списка с именем "Клиент" я выбираю точное значение 'Клиент №1'
	И из выпадающего списка с именем "Договор" я выбираю точное значение 'Договор 1Д'
	...
	И в таблице "Список" я перехожу к строке:
		| 'Код'       | 'Наименование'            |
		| '000000004' | 'Еремин Никита Андреевич' |
	...
	И в таблице "Список" я перехожу к строке:
		...
		| '15.07.2025 12:00:00' | 'Договор 1Д' 	 | 'Клиент №1'       | '000000007' | 'Демин Михаил Александрович' |
